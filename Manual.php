  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-home"></i> Manual</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="fa fa-files-o"></i>Kitchen</li>
                        <li><i class="fa fa-files-o"></i>Manual Issue</li>
                                      ...
                                      <div class="col-sm-6">
                                          ...
                                          <table class="table table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>1</td>
                                                        <td>Fortune Coconut Oil 500ml</td>
                                                        <td>75</td>
                                                    </tr>
                                                    <tr>
                                                        
                                                        <td>2</td>
                                                        <td>Maggi Coconut Milk Powder 800g</td>
                                                        <td>100</td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>Renuka Coconut Milk Thick Can 400m</td>
                                                        <td>20</td>
                                                    </tr>
                                                    <tr>
                                                      
                                                        <td>4</td>
                                                        <td>BEGA Cheese Slices 100g</td>
                                                        <td>90</td>
                                                    </tr> 
                                                    </tbody>
                                                </table>
